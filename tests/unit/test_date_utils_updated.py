...
class TestDateUtils:
    ...
    def test_parse_date(self):
        ...
        assert parse_date("01/15/2023", "%m/%d/%Y") == datetime(2023, 1, 15)
        ...
        with pytest.raises(DateFormatError):
            parse_date("2023-01-32")  # Invalid day
    ...
    def test_format_date(self):
        ...
        assert format_date(dt, "%m/%d/%y") == "01/15/23"
        assert format_date(dt, "%B %d, %Y") == "January 15, 2023"
        
        dt_with_time = datetime(2023, 1, 15, 14, 30, 45)
        assert format_date(dt_with_time, "%Y-%m-%d %H:%M:%S") == "2023-01-15 14:30:45"
    ...
    def test_detect_date_format(self):
        ...
        assert detect_date_format("15-01-23") == "%d-%m-%y"
        ...
        assert detect_date_format("01-02-2023") in ["%m-%d-%Y", "%d-%m-%Y"]
