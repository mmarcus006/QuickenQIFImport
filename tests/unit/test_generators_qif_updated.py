...
class TestQIFGenerator:
    ...
    def test_get_enum_value(self):
        ...
        assert generator._get_enum_value(ClearedStatus.CLEARED) == "*"
        assert generator._get_enum_value(ClearedStatus.RECONCILED) == "X"
        assert generator._get_enum_value(ClearedStatus.UNCLEARED) == ""
    ...
    def test_generate_with_empty_transactions(self):
        ...
        with pytest.raises(QIFGeneratorError):
            generator.generate_qif([], AccountType.BANK, "Checking")
