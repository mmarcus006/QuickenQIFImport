...
class TestCSVGenerator:
    ...
    def test_generate_bank_csv(self, bank_transactions, bank_template):
        ...
        csv_content = generator.generate(bank_transactions, bank_template)
        ...
        assert "2023-01-16,1200.00,Paycheck,Income:Salary,January salary,DIRECT DEP" in csv_content
        assert "2023-01-17,-125.50,Grocery Store,Food:Groceries,Weekly groceries," in csv_content
    ...
    def test_generate_investment_csv(self, investment_transactions, investment_template):
        ...
        csv_content = generator.generate(investment_transactions, investment_template)
        
        assert "Date,Action,Security,Quantity,Price,Amount,Commission,Memo,Category" in csv_content
        
        assert "2023-01-15,Buy,AAPL,10,150.75,-1507.50,7.50,Buy Apple stock,Investments:Stocks" in csv_content
        assert "2023-01-16,Sell,MSFT,5,250.25,1251.25,6.25,Sell Microsoft stock,Investments:Stocks" in csv_content
        assert "2023-01-17,Div,VTI,,,75.00,,Dividend payment,Income:Dividends" in csv_content
    ...
    def test_generate_csv_file(self, bank_transactions, bank_template):
        ...
        with patch("builtins.open", mock):
            generator.generate_to_file(bank_transactions, bank_template, "/path/to/output.csv")
    ...
    def test_generate_with_invalid_account_type(self, bank_transactions):
        """Test generating CSV with invalid account type."""
        generator = CSVGenerator()
    ...
    def test_generate_with_missing_fields(self, bank_transactions):
        ...
        csv_content = generator.generate(bank_transactions, template)
